const CACHE='ludia-nail-v2.16.1';
const CORE=['./','index.html','styles.css','salon-cloud.js','app.js','checkout-ui.js','checkout-ui.css','sales-ui.js','sales-ui.css','membership-ui.js','membership-ui.css','staff-ui.js','staff-ui.css','booking-availability-ui.js','booking-availability-ui.css','calendar-availability-ui.js','calendar-availability-ui.css','customer-ui.js','customer-ui.css','customer-profile-editor.js','customer-profile-editor.css','customer-retention-ui.js','customer-retention-ui.css','manifest.webmanifest'];
...
async function appShell(request){
 try{
  ...
  for(const js of ['sales-ui.js','membership-ui.js','staff-ui.js','booking-availability-ui.js','calendar-availability-ui.js','customer-ui.js','customer-profile-editor.js','customer-retention-ui.js'])if(!html.includes(js))html=html.replace('</body>',`  <script src="${js}"></script>\n</body>`);
