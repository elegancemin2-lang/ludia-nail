const CACHE='ludia-nail-v2.15.0';
const CORE=['./','index.html','styles.css','salon-cloud.js','app.js','checkout-ui.js','checkout-ui.css','sales-ui.js','sales-ui.css','membership-ui.js','membership-ui.css','staff-ui.js','staff-ui.css','booking-availability-ui.js','booking-availability-ui.css','calendar-availability-ui.js','calendar-availability-ui.css','customer-ui.js','customer-ui.css','customer-profile-editor.js','customer-profile-editor.css','manifest.webmanifest'];
...
async function appShell(request){
 try{
  ...
  for(const css of ['checkout-ui.css','sales-ui.css','membership-ui.css','staff-ui.css','booking-availability-ui.css','calendar-availability-ui.css','customer-ui.css','customer-profile-editor.css'])if(!html.includes(css))html=html.replace('</head>',`  <link rel="stylesheet" href="${css}" />\n</head>`);
  ...
  for(const js of ['sales-ui.js','membership-ui.js','staff-ui.js','booking-availability-ui.js','calendar-availability-ui.js','customer-ui.js','customer-profile-editor.js'])if(!html.includes(js))html=html.replace('</body>',`  <script src="${js}"></script>\n</body>`);
